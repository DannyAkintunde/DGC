...
ALLOWED_HOSTS = ['.vercel.app','.now.sh', '127.0.0.1','.localhost','.uks1.devtunnels.ms','https://test.diamondgiantconsulting.com/','diamondgiantconsulting.com','www.diamondgiantconsulting.com','.com']
